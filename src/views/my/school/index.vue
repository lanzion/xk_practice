<template>
  <div class="container">
    <div class="nimi">
      ...
      <div class="g-search--wrap clearfix">
        ...
        <el-form :inline="true" class="fr">
          <el-form-item>
            <el-input v-model="name" placeholder="请输入学校的关键字" @keyup.native.enter="resetPage"></el-input>
          </el-form-item>
          <el-form-item>
    ...
    <div class="cord">
      <ul>
        <li v-for="(g,index) in datas" :key="index" @click="changes(g.id,g.actNum)">
          <div class="cord-img">
