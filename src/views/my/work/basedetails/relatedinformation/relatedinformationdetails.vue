            ...
            <div class="container">
                <div class="container_one">
                    <div class="container_one_l">
                        <!-- <el-image :src="lists.cover" style="width: 400px;height:240px">
                            <div
                                slot="error"
                                class="image-slot"
                        ...
                        <ov-image :src-data="getFileUrl(lists.cover)"></ov-image>
                    </div>
...
export default {
    ...
    methods: {
        ...
        async getlist(fid) {
            let res = ''
            if (fid) {
                res = await detailsofpublicinformation({ id: fid })
            } else {
            ...
            this.lists = JSON.parse(sessionStorage.getItem('baselist'))
        },
        async getdatas() {
            let res = await getalistofinformation(
                { orgType: 'B', isrecommend: 'A' },
                this.pages
            )
