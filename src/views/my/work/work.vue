<template>
  <div class="diyt">
    ...
    <div class="container">
      <div :style="{'width':'100%','height':'40px','lineHeight':'40px'}"></div>
      <div class="aggregate_one">
        <div :style="{'marginBottom':'30px','background':'#fff'}">
          ...
          <div class="aggregate_one_q">
            <ul class="aggregate_one_t_w">
              <li @click="goshowone(l.id)" v-for="(l,index) in goodsover" :key="index">
                <span>{{l.name}}</span>
