    ...
    <div class="workshow">
      ...
      <div class="conent_thr">
        ...
        <div class="conent_thr_name">
          <div class="conent_thr_name_q" :style="{'backgroundImage':'url('+conentimgone+')'}">
            <span>负责人</span>
            <span>{{datas.personInCharge}}</span>
          </div>
          <div class="conent_thr_name_q" :style="{'backgroundImage':'url('+conentimgtwo+')'}">
            <span>联系方式</span>
      ...
      <div class="conent_for">
        <div class="listsdetail_fl_two_m">
          ...
          <div class="listsdetail_fl_two_m_b">
            <ul>
              <li class="listsdetail_fl_two_m_s" v-for="(r,index) in lists" :key="index">
                <div class="listsdetail_fl_two_m_s_one">
                  <!-- <img :src="r.reviewerCover" alt /> -->
                  <el-avatar :size="80" :src="r.reviewerCover" @error="errorHandler">
                ...
                <div class="listsdetail_fl_two_m_s_two">
                  ...
                  <div class="textimg">
                    <div class="textimgs" v-for="(a,index) in r.resources" :key="index">
...
export default {
  ...
  methods: {
    ...
    async getlist() {
      ...
      this.baselist = JSON.parse(sessionStorage.getItem("baselist")) || "";
    },
    async getbaselist() {
      let kid = localStorage.getItem("zid");
      let oid = this.$route.query.id;
      ...
      let res = await baseserviceevaluationlist({ serverId: id }, this.pages);
