    ...
    data() {
        return {
            ...
            arr: [
                {
                    name: '首页',
                    url: '/participation/participationdetails/schoolhomepage'
                },
                {
                    name: '实践课程',
                    url: '/participation/participationdetails/schoolcurriculum'
                },
                {
                    name: '校园资讯',
                    url: '/participation/participationdetails/schoolinformation'
                }
            ]
        }
    },
