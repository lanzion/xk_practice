<template>
  <div class="workdetail">
    <div class="container">
      ...
      <div class="workdetail_fl fl" :style="{'background':'#fff'}">
        <div class="workdetail_fl_one">
          <div class="workdetail_fl_one_q">
            <ul>
          ...
          <div class="workdetail_fl_one_w" v-show="issgow" v-if="!nomore">
            <div class="bigimg">
          ...
          <div class="workdetail_fl_one_w" v-show="!issgow">
            <div class="tovideos">
              <video controls :src="videourls"></video>
            </div>
          </div>

          <div class="workdetail_fl_one_e">
            <div>
          ...
          <div class="workdetail_fl_one_t">
            <p>作品简介:{{datas.description}}</p>
          </div>
        </div>

        <div class="workdetail_fl_two">
          <div class="workdetail_fl_two_y">
            <h4>评论</h4>
            <textarea
              name
              id
          ...
          <div class="workdetail_fl_two_u">
            <div>
              <ul>
                <li v-for="(g,index) in commentlist" :key="index">
                  <div class="workdetail_fl_two_u_one">
                    <img :src="g.face" alt />
                  </div>
                  <div class="workdetail_fl_two_u_two">
                    <div class="workdetail_fl_two_u_two_cq">
                      <span>{{g.userName}}</span>
                    </div>
                    <div class="workdetail_fl_two_u_two_cw">
                      <span>{{g.content}}</span>
                    </div>
                    <div>
...
<script>
import SIdentify from '@/components/my/identify/identify.vue'
        ...
        ul {
          ...
          li {
            ...
            .workdetail_fl_two_u_two {
              ...
              .workdetail_fl_two_u_two_cq {
                width: 100%;
                height: 20px;
              }
              .workdetail_fl_two_u_two_cw {
                width: 100%;
                span {
                  width: 720px;
                  display: block;
