    ...
    <div class="mywork">
      <div class="classroom_h">
        <ul>
          ...
          ></li>
          <div class="search-wrap fl tab-search">
            <section data-v-89dd130e class="search clearfix">
              <input data-v-89dd130e type="text" @change="changenew" v-model="newname" placeholder="请输入课程名称" class="search-text" />
    ...
    data() {
        return {
            ...
            lists: [
                {
                    name: '未评分',
                    path: '/space/evaluatingothers/evaluateotherswithoutscoring'
                },
                {
                    name: '已评分',
                    path: '/space/evaluatingothers/evaluateothersiscores'
                }
            ]
        }
    },
