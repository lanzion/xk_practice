    ...
    <div class="page-fl fl">
      ...
      <div class="page-fl-coure">
        <div class="page-fl-coure-header">
          <i class="page-fl-coure-header-min" :style="{backgroundImage:'url('+kechenglan+')'}"></i>
      ...
      <div class="page-fl-evaluate" v-if="nomoreone">
        <div class="page-fl-evaluate-header">
          <i class="page-fl-evaluate-header-min" :style="{backgroundImage:'url('+fankui+')'}"></i>
    ...
    <div class="page-fr fr">
      ...
      <div class="page-fr-two" v-if="nomoretwo">
        <div class="page-fr-two-header">
          ...
          <span class="page-fr-two-header-two">({{nums}}所)</span>
...
export default {
  ...
  methods: {
    ...
    async getSchoollist() {
      ...
      const res = await requestwebapibaseDetailschool({ id: this.id }, pages);
      const { entity: datas = {} } = res.data;
      try {
        this.lists = datas.resultData || [];
        this.nums = datas.totalNum;
      } catch (error) {
        this.lists = [];
      } finally {
        this.isLoading = false;
    ...
    go() {
      this.$router.push({
        ...
        query: { baseId: this.id, num: this.num }
      });
    },
    coursemore() {
      this.$router.push({
