  ...
  <div class="school-list-wrap">
    ...
    <div class="g-search--wrap clearfix">
      <el-form :inline="true" class="fl elFrom" @submit.native.prevent :mode="form">
        ...
        <el-form-item>
          <el-input v-model="form.eduName" placeholder="请输入教育局名称" @keyup.native.enter="resetPage"></el-input>
        </el-form-item>
    ...
    <el-table ref="table" :data="listData" stripe align="center" v-loading="isLoading" border>
      ...
      <el-table-column prop="eduName" label="教育局名称" align="center" />
...
import { baseEducationList, delEdus } from "@/api/resetApi";
