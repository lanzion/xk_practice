    ...
    <div class="submit-form backend-content__middle" style="padding-top:50px;">
        <el-form ref="form" :model="form" label-width="100px" :rules="rules">
            ...
            <el-form-item label="code" prop="code">
                <el-col :span="14">
                    <el-input v-model="form.code" placeholder="请输入code(大写或者_)" @input="checkCode" :disabled="isDisabled" maxlength="50"></el-input>
                </el-col>
           </el-form-item>
           <el-row>
...
<script>
import {activityTypeDetailEdit,activityTypeDetailData} from '@/api/resetApi'
export default {
    name: 'typeAdd',
    data() {
        return {
    ...
    methods: {
        ...
        getDetailData() {
            ...
            if (id) {
               activityTypeDetailData({ id }).then(res => {
                ...
                if (valid) {
                   this.isLoading = true;
                     const formList = Object.assign({}, this.form);
                       activityTypeDetailEdit(formList).then( response => {
