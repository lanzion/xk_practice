<template>
     <div class="school-list-wrap">
            ...
            <el-form :inline="true"  @submit.native.prevent>
                ...
                <el-form-item label="时间筛选" prop="activityTime">
                                    ...
                                    <el-date-picker
                                        ...
                                        end-placeholder="结束时间" @change="resetPage">
                                    </el-date-picker>
        ...
        <div id="myData">
            ...
            <div id="myChart"  :style="{width: '100%', height: '615px'}"></div>
             <div class="curList-list">
                当前统计: {{datas.searchDate}}
            </div>
            <div class="curList-list">
                 <span>总计</span> 
                 <span>实践课程:<em>{{datas.courseCount}}</em> </span>
                 <span>参与学校:<em>{{datas.schoolCount}}</em> </span>
                 <span>参与教师:<em>{{datas.teacherCount}}</em> </span>
                 <span>参与学生:<em>{{datas.studentCount}}</em> </span>
            </div>
        ...
        <div class="dtailedData">
            ...
            <el-table :data="tableData" style="width: 100%"  stripe align="center" id="rebateSetTable"   border :header-cell-style="{'background-color':'#eee', 'color':'#666'}">
       ...
       async handleDownload() {//导出列表
         ...
         if(!this.activityTime){
            ...
            import('@/vendor/Export2Excel').then(excel => {
                const tHeader = ['活动标题', '上课时间', '学校', '活动基地', '参与服务','参与班级','教师名称','参与学生']
                const filterVal = ['courseName', 'comeTime', 'schoolName', 'baseinfoName', 'projectName','className','teacherName','stuNum']
            ...
            myChart.setOption(
                {
                    ...
                    color: ['rgb(0,51,102)', 'rgb(0,102,153)', 'rgb(76,171,206)', 'rgb(229,50,62)'],
                    tooltip: {
                        trigger: 'axis',
                        axisPointer: {
                            type: 'shadow'
