<template>
  <div class="role-wrap" :loading="isLoading">
    ...
    <!-- 权限分配弹窗 -->
    <el-dialog title="权限分配" :visible.sync="visible" @close="resetDetail" width="30%">
      <permiss-tree
        ref="tree"
        class="dialog-menu-tree"
        :datas.sync="permissTree"
...
export default {
  ...
  components: {
    "permiss-tree": resolve =>
      require(["@/components/admin/system/permiss/permiss-tree-list"], resolve)
  },
  created() {
    this.getDatas();
    this.getPermissData();
