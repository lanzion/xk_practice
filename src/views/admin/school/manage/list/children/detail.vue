<template>
    <div class="content">
        ...
        <div class="school-detail-main-list">
                <span class="school-detail-list-head">学校代码</span>
                <div class="school-detail-list-redource">
                        {{datas.identityCode}}
                </div>
        </div>
        <div class="school-detail-main-list">
                <span class="school-detail-list-head">学校名称</span>
                <div class="school-detail-list-redource">
                        {{datas.schoolName}}
                </div>
        </div>
        <div class="school-detail-main-list">
                <span class="school-detail-list-head">学校描述</span>
                <div class="school-detail-list-title">
                         {{datas.remark}}
                </div>
        </div>
         <div class="school-detail-main-list">
                <span class="school-detail-list-head">学校学段</span>
                <div class="school-detail-list-redource">
                    <span v-if="datas.schoolType=='primarySchool'">小学</span>
                    <span v-else-if="datas.schoolType=='middleSchool'">初中</span>
                    <span v-else-if="datas.schoolType=='highSchool'">高中</span>
                </div>
        </div>
         <div class="school-detail-main-list">
         ...
         <div class="school-detail-main-list">
                <span class="school-detail-list-head">传真</span>
                <div class="school-detail-list-redource">
                       {{datas.fax}}
                </div>
        </div>
         <div class="school-detail-main-list">
                <span class="school-detail-list-head">邮箱</span>
                <div class="school-detail-list-redource">
                       {{datas.email}}
                </div>
        </div>
         <div class="school-detail-main-list">
                ...
                <div class="school-detail-list-redource">
                    <span>{{datas.provinceName}}/</span>
                    <span>{{datas.cityName}}/</span>
                    <span>{{datas.areaName}}</span>
         ...
         <div class="school-detail-main-list">
                <span class="school-detail-list-head">主管部门</span>
                <div class="school-detail-list-redource">
                        {{datas.orgName}}
                </div>
        </div>
        <div class="school-detail-list">
            <div class="school-detail-item">
                      <span class="school-detail-list-head">LOGO</span>
                       <div class="school-detail-list-title">
                           <el-image :src="datas.cover" class="school-detail-img">
            ...
            <div class="school-detail-item">
                 <span class="school-detail-list-head">空间图</span>
                  <div class="school-detail-list-title">
                      <el-image :src="datas.designSpaceBackground" class="school-detail-img">
                            <div slot="placeholder" class="image-slot">
                                加载中<span class="dot">...</span>
                            </div>
                        </el-image>
         ...
         <div class="school-detail-main-list">
                <span class="school-detail-list-head">空间背景图</span>
                <div class="school-detail-list-redource">
                         <el-image :src="datas.designSpacePage" class="school-detail-img">
                            <div slot="placeholder" class="image-slot">
                                加载中<span class="dot">...</span>
                            </div>
                        </el-image>
...
import { schoolDetail } from '@/api/resetApi'
