        ...
        <el-form ref="form" :model="form" label-width="100px" :rules="rules">
                ...
                <el-col :span="8">
                        <el-form-item label="学段" prop="schoolType">
                             <el-checkbox-group v-model="form.schoolType">
                                <el-checkbox v-for="(item) in schoolArr" :label="item.id" :key="item.id">{{ item.name }}</el-checkbox>
                            </el-checkbox-group>
                        </el-form-item>   
                </el-col>
            </el-row>
              <el-row>
                <el-col :span="10">
                    <el-form-item label="学校描述" prop="remark">
                        <el-input type="textarea" :rows="4" placeholder="请输入学校描述" v-model="form.remark" ></el-input>
                    </el-form-item> 
                </el-col>
            </el-row>
            ...
            <el-row v-if="!isReadOnly">
                 <el-col :span="8" >
                        <el-form-item label="所属地区" prop="provinceId">
                                ...
                                <region  type="object" @change="changeRegion" :default="default1"  class="regions"></region>
            ...
            <el-row v-if="isReadOnly">
                 <el-col :span="8" >
                        <el-form-item label="所属地区" prop="provinceId">
                               ...
                               <el-input v-model="location" :disabled="isReadOnly" ></el-input>
            ...
            <el-row>
                <el-form-item label="主管部门" prop="baseId">
                    <el-col :span="8">
                        <el-select v-model="form.baseId" placeholder="请选择主管部门" :disabled="isReadOnly"   >
                            <el-option v-for="item in baseList" :label="item.eduName" :value="item.id" :key="item.id"></el-option>
                        </el-select>
                    </el-col>
                </el-form-item>
            </el-row>
...
import {baseEducationList,schoolEdit,schoolDetail} from '@/api/resetApi'
...
export default {
    ...
    data() {
        return {
            ...
            rules: {
                remark:[{
                     required: true, message: '请输入学校描述', trigger: ['change','blur']
                }],
                schoolType:[{
                     required: true, message: '请选择学段', trigger: ['change','blur']
                }],
                designSpacePage:[{
        ...
        onSubmit() {
            this.$refs.form.validate((valid) => {
                if (valid) {
                    ...
                    schoolEdit(formList).then( response => {
    ...
    created() {
       ...
       if(this.identiy==6||this.identiy==7||this.identiy==10){
            ...
            // this.form.provinceId =baseInfo.baseInfo.provinceId;
            // this.form.cityId =baseInfo.baseInfo.cityId;
            // this.form.areaId =baseInfo.baseInfo.areaId;
            // this.getSchoolList();
