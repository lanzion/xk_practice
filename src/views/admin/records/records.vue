    ...
    <div class="g-search--wrap clearfix">
      <el-form :inline="true" :model="search" class="fl elFrom" @submit.native.prevent>
        ...
        <el-form-item class="fr">
          <el-form-item label>
            <el-input v-model="keyword" placeholder="实践主题/发起机构搜索" @keyup.native.enter="resetPage"></el-input>
          </el-form-item>
          <el-button type="primary" plain @click="getDatas">查询</el-button>
      ...
      <!-- <section class="g-table--head clearfix fr">
        <head-operate
          ...
          v-bind="{
                    del: { callback: doDel },
                    password: { callback: popupPassword },
      ...
      >
        ...
        <el-table-column prop="account" label="实践主题" align="center" />
        <el-table-column prop="theme" label="实践描述" align="center" />
        <el-table-column prop="type" label="发起机构" align="center" />
