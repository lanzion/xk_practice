    ...
    <el-form-item label="用户名" prop="userName">
      ...
      <el-form-item label="用户头像" prop="cover">
       ...
       <el-row v-if="!isReadOnly">
                ...
                <el-col :span="12">
                    <el-form-item label="所属学校"  prop="baseId">
                             <el-select filterable
    remote v-model="form.baseId" placeholder="请所属学校" :remote-method="remoteMethod" @change="getUpdateRight">
                                <el-option v-for="item in schoolList" :label="item.schoolName" :value="item.id" :key="item.id"></el-option>
                            </el-select>
                    </el-form-item>
                 </el-col>
            </el-row>
    <!-- <el-form-item label="所属学校" prop="baseId" v-if="!isReadOnly">
      <el-col :span="12">
        <el-select v-model="form.baseId" placeholder="请选择学校">
...
import { getByPid,schoolList,addUser } from "@/api/resetApi";
...
export default {
  ...
  created() {
    if(identiy==9){
      ...
      this.schoolName = baseInfo.school.schoolName;
      this.getUpdateRight();
    }else if(identiy==5||identiy==6||identiy==7||identiy==10){
