<template>
   <div class="school-list-wrap">
        ...
        <el-table  @selection-change="handleSelectionChange" ref="table" :data="listData" stripe align="center" v-loading="isLoading" border :header-cell-style="{'background-color':'#eee', 'color':'#666'}">
