        ...
        >
            <div class="comment_conten">
                ...
                <div class="comment_txt">
                    ...
                    <el-row
                        class="comment_box"
                        v-for="item in activityData.evalPoints"
                        :key="item.pointCode"
                    >
                        <el-col :span="4">
                            ...
                            <div class="comment_say_info_left">
                                ...
                                <div class="comment_say_info_left_list">
                                    ...
                                    <div class="evalpointsbox" v-else>
                                        ...
                                        <div
                                            class="comment_say_info_left_say"
                                        >评语：{{seyCommentData.schBaseEval.comment}}</div>
                                    </div>
                                </div>
                            </div>
                        </el-col>
                            ...
                            <div class="comment_say_info_right">
                                ...
                                <div class="comment_say_info_left_list">
                                    ...
                                    <div class="evalpointsbox" v-else>
                                        ...
                                        <div
                                            class="comment_say_info_left_say"
                                        >评语：{{seyCommentData.baseSchEval.comment}}</div>
                                    </div>
                                </div>
                            </div>
                        </el-col>
...
export default {
    ...
    created() {
        ...
        if (this.identity == 9) {
            this.evalPointsTitle = '学校对基地评价'
            this.active = 1
        } else if (this.identity == 13) {
            this.evalPointsTitle = '基地/机构对学校评价'
            this.active = 2
        } else if (
            this.identity == 6 ||
            this.identity == 7 ||
