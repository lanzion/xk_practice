    ...
    <el-form ref="form" class="g-form--wrap" label-width="100px" :model="form" :rules="rules">
        ...
        <el-form-item label="报名时间" prop="enrollEndDateStr">
            <el-row>
                <el-col :span="14">
                    <div
                        class="c-datepicker-date-editor J-datepicker-range-between30 mt10 enrolldate"
                    >
...
import { fit, status } from '@/utils/utility/dict.js'
...
export default {
    ...
    data() {
        return {
            ...
            fit: fit,
            status: status,
            isFree: [{ code: 0, name: '免费' }, { code: 1, name: '收费' }],
            isClear: false,
            activityList: [],
            cover: [],
        ...
        addActivity() {
            this.activityArr.forEach((v, i) => {
                ...
                if ($('.activityEndDateStr' + i).val()) {
                    // eslint-disable-next-line no-undef
                    v.activityStartDateStr = $(
                        '.activityStartDateStr' + i
                    ).val()
                    // eslint-disable-next-line no-undef
                    ...
                    hide: function(type) {
                        _this.activityArr.forEach((v, i) => {
                            if ($('.activityEndDateStr' + i).val()) {
                                ...
                                v.activityEndDateStr = $(
                                    '.activityEndDateStr' + i
                                ).val()
                            }
                        })
                    }
