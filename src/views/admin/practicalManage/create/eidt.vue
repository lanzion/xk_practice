...
import { courseEdit,getActivityTypeParent,courseDetail,selectAllList} from '@/api/resetApi'
            ...
            if (id) {
                courseDetail({ id }).then(res => {
                    ...
                    if (code === 200 && datas) {
                        ...
                        this.form.target = datas.target;
                        this.form.fit = datas.fit;
                        this.form.id =datas.id;
                        this.form.isCompulsory = datas.isCompulsory;
                        this.form.content = datas.content;
                        this.form.courseType = datas.courseType;
                        this.form.courseTypeParent =datas.courseTypeParent;
                        this.form.values =[datas.courseTypeParent,datas.courseType],
            ...
            this.$refs.form.validate((valid) => {
                if (valid) {
                    ...
                    const formData ={
                        ...
                        if(formList.activityId!=''){
                            formData.activityId = formList.activityId//活动id
                        }
